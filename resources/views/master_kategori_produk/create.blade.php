...
<div class="w-full px-6 py-6 mx-auto mt-10">
    <div class="bg-white shadow-lg rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Tambah Kategori Produk Jadi</h2>
        <form action="{{ route('master_kategori_produk.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="kode" class="block font-semibold">Kode Produk Jadi</label>
                <input type="text" name="kode" id="kode" class="w-full border p-2 rounded-lg" placeholder="Masukkan Kode Produk Jadi" required>
            </div>
            <div class="mb-4">
