...
<div class="w-full px-6 py-6 mx-auto mt-10">
    <div class="bg-white shadow-lg rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Tambah Kategori Bahan Baku</h2>
        <form action="{{ route('kategori_bahan_baku.store') }}" method="POST">
            @csrf
            <div>
                <label for="kode_kategori" class="block text-sm font-medium text-gray-700">Kode Kategori</label>
                <input type="text" name="kode_kategori" id="kode_kategori" class="mt-1 block w-full border border-gray-300 rounded py-2 px-3" required>
            </div>
            <br>
            <div>
                <label for="nama_kategori" class="block text-sm font-medium text-gray-700">Nama Kategori</label>
                <input type="text" name="nama_kategori" id="nama_kategori" class="mt-1 block w-full border border-gray-300 rounded py-2 px-3" required>
            </div>
            <br>
            <div>
