...
<head>
    ...
    <title>FORMULIR PENGEMBALIAN</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="header-text">FORMULIR PENGEMBALIAN BARANG</div>
    </div>

    <table class="table-no-border">
        <tr>
            <td><strong>NOMOR PENGEMBALIAN BARANG</strong></td>
            <td>:</td>
            <td>{{ $data[0]->nomor_pengembalian_barang }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>JENIS PENGEMBALIAN</strong></td>
            <td>:</td>
            <td>{{ $data[0]->jenis_pengembalian }}</td>
        </tr>
        <tr>
            <td><strong>TUJUAN PENGEMBALIAN</strong></td>
            <td>:</td>
            <td>{{ $data[0]->tujuan_pengembalian_barang }}</td>
        </tr>
    </table>
    <table>
        <thead>
