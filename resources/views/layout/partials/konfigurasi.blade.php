...
<body>
  <main>
    <div fixed-plugin>
      <a fixed-plugin-button class="fixed px-4 py-2 text-xl bg-black shadow-lg cursor-pointer bottom-8 right-8 z-990 rounded-circle text-slate-700">
        <i class="py-2 pointer-events-none fas fa-cog text-white"></i>
      </a>
      ...
      <div fixed-plugin-card class="z-sticky backdrop-blur-2xl backdrop-saturate-200 dark:bg-slate-850/80 shadow-3xl w-90 ease -right-90 fixed top-0 left-auto flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white/80 bg-clip-border px-2.5 duration-200">
        <div class="px-6 pt-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
          <div class="float-left">
            <h5 class="mt-4 mb-0 dark:text-white">PT DWIJAYA COSMEDIKA Konfigurasi</h5>
            <p class="dark:text-white dark:opacity-80">Pengaturan aplikasi</p>
          </div>
        ...
        <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
          ...
          <div class="mt-4">
            ...
            <p class="text-sm leading-normal dark:text-white dark:opacity-80">Pilih antara 2 jenis sidenav yang berbeda.</p>
          </div>
          <div class="flex">
          ...
          <p class="block mt-2 text-sm leading-normal dark:text-white dark:opacity-80 xl:hidden">Anda dapat mengubah jenis sidenav hanya pada tampilan desktop.</p>
          <!-- Navbar Fixed -->
          <div class="flex my-4">
            <h6 class="mb-0 dark:text-white">Navbar</h6>
          ...
          <div class="w-full text-center">
            <h6 class="mt-4 dark:text-white">Terima Kasih Sudah Mengunjungi</h6>
          </div>
        </div>
      </div>
    </div>
